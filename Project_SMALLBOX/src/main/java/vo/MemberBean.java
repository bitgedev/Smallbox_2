...
public class MemberBean {
	...
	public MemberBean(int member_idx, String member_name, String member_id, String member_passwd, String member_email,
			String member_phone, Date member_join_date, Date member_birth_date, String member_point) {
		super();
