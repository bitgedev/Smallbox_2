...
public class MemberDTO {
	...
	private Date member_join_date; // 딱히 사용은 안할듯
	private Date member_birth_date; // 티켓 가격 산정 
	...
	public String toString() {
		return "MemberDTO [member_idx=" + member_idx + ", member_id=" + member_id + ", member_passwd=" + member_passwd
